...
import WebAppIcon from "@lucide/svelte/icons/laptop-minimal";
...
<nav class="flex gap-2 p-4 items-center">
	<Button onclick={toggleMode} variant="outline" size="icon">
		<SunIcon class="h-[1.2rem] w-[1.1rem] scale-100 rotate-0 transition-all! dark:scale-0 dark:-rotate-90"/>
