...
<CalendarPrimitive.Day
	...
	class={cn(
		...
		// Outside months
		"data-[outside-month]:opacity-30 [&[data-outside-month]:not([data-selected])]:text-muted-foreground [&[data-outside-month]:not([data-selected])]:hover:text-accent-foreground",
		// Disabled
